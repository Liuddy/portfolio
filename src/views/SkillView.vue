...
<template>
  ...
  <div id="skillGrid">
    ...
    <div class="skillFlex">
      ...
      <div v-for="skillList in skillTab.slice(skillTab.length / 2, skillTab.length - 1)">
    ...
    <div class="techSkill">
      ...
      <div>
        ...
        <ul>
          <li v-for="(skill, index) in skillTab[skillTab.length - 1]">
            <img v-if="index % 2 === 0" :src="getImgPath('icons', skill)"
            :alt="`Logo de ${ skill }`">
            <p v-if="index % 2 === 0"> {{ skill }} </p>
            <p v-if="index % 2 === 0">{{ getSkillLevelIcons(skillTab[skillTab.length - 1][index + 1]) }}</p>
          </li>
        </ul>
